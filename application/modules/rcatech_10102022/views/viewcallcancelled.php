				              ...
				              <tr>
              				 ...
              				 <tbody> 
					              ...
					              ?>
					                ...
					                <?php if ($access_right['edit_rights'] == 1) { ?>
					                <td>
					                  <?php  $file_status = array('Pending','Invoiced','Completed','Cancelled','Inspection Started','Report Pending','Report Assigned'); ?>
