			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="#">
								View Report Generation Register
							</a>
						</li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>View Report Generation Register
							</div>
							<div class="actions">
								<?php /*if ($access_right['add_rights'] == 1) { ?>
								<a href="<?php echo BASE_PATH; ?>Callgenerationregister" class="btn blue">
									<i class="fa fa-pencil"></i> New Report Generation 
								</a>
								<?php } */ ?>
								<!--<div class="btn-group">
				              ...
				              <tr>
              				 ...
              				 <tbody> 
					              ...
					              ?>
					                ...
					                <td>
					                  <?php echo $call_data['report_no']; ?>
					                </td>
					                <td>
					                  <?php echo $call_data['call_no']; ?>
					                </td>
					                <td>
					                   <?php echo $call_data['file_no']; ?>
					                </td>					                
					                <td>
					                ...
					                <?php if ($access_right['edit_rights'] == 1) { ?>
					                <td>
					                  <?php  $file_status = array('Pending','Scheduled','Completed','Cancelled','Inspection Started','Report Assigned'); ?>
