							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal reportgen-form" enctype="multipart/form-data" onsubmit="submitForm()">
										...
										<input type="hidden" name="client_id"	id="client_id" value="<?php echo $file_data[0]['client_id']; ?>">
										<input type="hidden" name="file_class"	id="file_class" value="<?php echo $file_data[0]['file_classification']; ?>">
											
											<div class="form-body">

												
												<h3 class="form-section alert alert-info">Call Info - On Submit Report No Email will goto inspector</h3>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="engineer_data[]" id="engineer_data" multiple disabled>
																<?php
											...
											<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3"><font color="red">Generate Report*</font></label>
															<div class="col-md-9">
																<select class="form-control input-large" data-placeholder="Select..." name="report_gen" id="report_gen">
																	<option value="">Please Select</option>
																	<option value="1">Yes</option>
																</select>
																<span for="report_gen" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--<div class="col-md-6">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="col-md-offset-9 col-md-9">
															...
															<a href="<?php echo BASE_PATH; ?>Viewreportgenerationlist"><button type="button" class="btn default">Cancel</button></a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
