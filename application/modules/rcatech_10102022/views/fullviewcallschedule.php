			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?php echo BASE_PATH; ?>Viewcallschedule">
								File
							</a>
							<i class="fa fa-angle-right"></i>
						</li>
													...
													<div class="col-md-12">
														...
														<div class="table-responsive">
															...
															<tbody>
																...
																<td>
																	 <?php echo date('d-m-Y',strtotime($rows['call_from_date'])); ?>
																</td>
																<td>
																	<?php echo date('d-m-Y',strtotime($rows['call_to_date'])); ?> 
																</td>
																</tr>
															<?php } ?>
															</tbody>
