							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<input type="hidden" name="file_id" id="file_id" value="<?php echo $file_data[0]['id'];?>">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="file_date" id="file_date" value="<?php echo date('d-m-Y',strtotime($file_data[0]['file_creation_date'])); ?>" style="width:25%" readonly>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="file_source" id="file_source">
																	...
																	if ($rows['id']==$file_data[0]['file_source']) {	
																	?>
																	<option value="<?php echo $rows['id']; ?>" selected><?php echo $rows['file_source']; ?></option>
																	<?php } else { ?>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="clients_name" id="clients_name" disabled>
																	<option value=""></option>
																	<?php foreach($clients_data as $rows) {  
																	if ($rows['id']==$file_data[0]['client_id']) {
																	?>
																	<option value="<?php echo $rows['id']; ?>" selected><?php echo $rows['client_name']."  (".$rows['city'].")"; ?></option>
																	<?php } } ?>
																</select>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="client_shortname" id="client_shortname" value="<?php echo $file_data[0]['file_class']; ?>" style="width:25%" readonly>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="currency_name" id="currency_name">
																	...
																	if ($rows['id']==$file_data[0]['currency_id']) {
																	?>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="work_type" id="work_type">
																	...
																	if ($rows['id']==$file_data[0]['work_type']) {
																	?>
																	<option value="<?php echo $rows['id']; ?>" selected><?php echo $rows['work_name']; ?></option>
																	<?php } else { ?>
											...
											<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="category_name" id="category_name">
																	...
																	if ($rows['category_name']==$file_data[0]['category_name']) {
																	?>
																	<option value="<?php echo $rows['id']; ?>" selected><?php echo $rows['category_name']; ?></option>
																	<?php } else {  ?>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
																<textarea class="form-control" rows="3" name="file_remarks" id="file_remarks"><?php echo $file_data[0]['file_remarks']; ?></textarea>
															</div>
														</div>
													</div>
													<!--/span-->
