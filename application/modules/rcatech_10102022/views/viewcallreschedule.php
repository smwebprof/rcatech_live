				              ...
				              <tr>
              				 ...
              				 <tbody> 
					              ...
					              ?>
					                ...
					                <td>
					                  <a href="<?php echo BASE_PATH; ?>fullviewcallreschedule?id=<?php echo base64_encode($call_data['id']); ?>&fid=<?php echo base64_encode($call_data['file_id']); ?>"><?php echo $call_data['call_no']; ?></a>
					                </td>
					                <td>
					                   <a href="<?php echo BASE_PATH; ?>fullviewcallreschedule?id=<?php echo base64_encode($call_data['id']); ?>"><?php echo $call_data['file_no']; ?></a>
					                </td>					                
					                <td>
					                ...
					                <?php if ($access_right['edit_rights'] == 1) { ?>
					                <td>
					                  <?php  $file_status = array('Invoiced','Completed','Cancelled','Pending','Inspection Started','Report Pending','Report Assigned'); ?>
