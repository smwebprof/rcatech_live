...
class Viewreportgenerationlist extends MX_Controller {
	...
	public function index()
	{
		...
		if (@$_POST['viewfileregister']) {
			...
			$data['title'] = 'RCAinet - Viewreportgenerationlist';
			#$this -> load -> model('campaign_model');
			
			$data['layout_body']='viewreportgenerationlist';

			$result = $this->Call_master->getCallGenerationAllDataByReport();
	    	//print_r($result);exit;
