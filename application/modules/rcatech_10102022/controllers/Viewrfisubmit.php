...
class Viewrfisubmit extends MX_Controller {
	...
	public function index()
	{
		...
		if (@$_POST['viewfileregister']) {
			...
			$data['title'] = 'RCAinet - Viewrfisubmit';
			#$this -> load -> model('campaign_model');
			
			$data['layout_body']='viewrfisubmit';

			$result = $this->Call_master->getRFIAllData();
	    	//print_r($result);exit;
