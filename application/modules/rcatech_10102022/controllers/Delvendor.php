...
class Delvendor extends MX_Controller {
	...
	public function index()
	{
		...
		$data['title'] = 'ACI - Vendor Master';
		#$this -> load -> model('campaign_model');
		
		$data['layout_body']='delvendor';

		$result = $this->General_master->delvendor($params);

		########################### Log Activity ######################################
            $this->load->model('Activity_master');
            $params['module'] = 'delvendor';
            $params['date_time'] = $dt;
        ...
        ##################################################################
 		...
 		$viewinteractions = BASE_PATH."Viewvendors";
