								...
								<div class="portlet box green">
									<div class="portlet-title">
										...
										<a href="<?php echo BASE_PATH; ?>Viewcallcancelled" class="btn red">
											<i class="fa fa-pencil"></i> View Call Cancel List
										</a>
									    </div>
										<!--<div class="tools">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="call_file_no" id="call_file_no">
																	<option value="">Please Select</option>
																	<?php foreach($file_data as $rows) {  ?>
																	<option value="<?php echo $rows['id']; ?>"><?php echo $rows['file_no']; ?></option>
																	<?php } ?>
																</select>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="call_no" id="call_no">
																	<option value="">Please Select</option>
																</select>
