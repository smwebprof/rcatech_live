				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>View Call Cancelled Register
							</div>
							<div class="actions">
								<?php if ($access_right['add_rights'] == 1) { ?>
								<a href="<?php echo BASE_PATH; ?>Callcancelregister" class="btn blue">
									<i class="fa fa-pencil"></i> New Call Cancelled 
								</a>
								<?php } ?>
								<!--<div class="btn-group">
