				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>View RFI Sent Register
							</div>
							<div class="actions">
								<?php if ($access_right['add_rights'] == 1) { ?>
								<a href="<?php echo BASE_PATH; ?>Addrfiregister" class="btn blue">
									<i class="fa fa-pencil"></i> New RFI Sent
								</a>
								<?php } ?>
								<!--<div class="btn-group">
				              ...
				              <tr>
              				 ...
              				 <tbody> 
					              ...
					              ?>
					                ...
					                <td>
					                   <a href="<?php echo BASE_PATH; ?>fullviewfileregister?id=<?php echo base64_encode($rfi_data['id']); ?>"><?php echo $rfi_data['client_id']; ?></a>
					                </td>
					                <td>
					                  <?php echo $rfi_data['rfi_no']; ?>
					                </td>
					                <td>
					                  <?php echo date("d-m-Y", strtotime($rfi_data['rfi_sent_date'])); ?>
					                </td>
					                <td>
					                  <?php echo $rfi_data['document_path']; ?>
					                </td>
					                <td>
					                  <?php echo $rfi_data['first_name']; ?>
					                </td>			               
					                <td class="center">
					                    <?php echo $rfi_data['status']; ?>
					                </td>
					                <?php if ($access_right['edit_rights'] == 1) { ?>
					                <td>
					                  <?php  $file_status = array('Invoiced','Completed','Cancelled'); ?>
					                  <?php  if (!in_array($rfi_data['status'], $file_status)) { ?>
					                  <span class="label label-sm label-success">
					                     <a href="<?php echo BASE_PATH; ?>editfileregister?id=<?php echo base64_encode($rfi_data['id']); ?>"  style="color:#fff">Edit</a>
					                  </span><br/><br/>
					                  <?php } ?>
					                </td>
					                <?php } ?>
