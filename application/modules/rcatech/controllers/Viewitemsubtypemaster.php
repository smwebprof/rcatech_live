...
class Viewitemsubtypemaster extends MX_Controller {
	...
	public function index()
	{
		...
		$data['title'] = 'RCAinet Tech - Item Sub Type Master';
		#$this -> load -> model('campaign_model');
		
		$data['layout_body']='viewitemsubtypemaster';

		$result = $this->Item_master->getItemSubTypedata();
		//print_r($result);exit;
