	...
	public function index()
	{
		...
		if ($_POST) {
         ...
         //$resultdata = 111;
			...
			$fid = base64_decode($_GET['id']);
         $client_id = base64_decode($_GET['cnid']); 
         $fno = base64_decode($_GET['fno']);

         $client_details = $this->Client_master->getClientdataById($client_id);
         ...
         //print_r($countries);exit;
			...
			$data['layout_body']='addcallgenerationregister';
