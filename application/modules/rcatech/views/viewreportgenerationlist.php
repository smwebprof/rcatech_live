				              ...
				              <tr>
              				 ...
              				 <tbody> 
					              ...
					              ?>
					                ...
					                <td>
					                  <a href="<?php echo BASE_PATH; ?>fullviewcallschedule?id=<?php echo base64_encode($call_data['id']); ?>&fid=<?php echo base64_encode($call_data['file_id']); ?>"><?php echo $call_data['call_no']; ?></a>
					                </td>
					                <td>
					                   <a href="<?php echo BASE_PATH; ?>fullviewcallschedule?id=<?php echo base64_encode($call_data['id']); ?>"><?php echo $call_data['file_no']; ?></a>
					                </td>					                
					                <td>
					                ...
					                <?php if ($access_right['edit_rights'] == 1) { ?>
					                <td>
					                  <?php  $file_status = array('Pending','Scheduled','Completed','Cancelled','Inspection Started'); ?>
					                  <?php  if (!in_array($call_data['status'], $file_status)) { ?>
					                  <span class="label label-sm label-success">
					                     <a href="<?php echo BASE_PATH; ?>Reportgenerationregister?id=<?php echo base64_encode($call_data['id']); ?>&fid=<?php echo base64_encode($call_data['file_id']); ?>"  style="color:#fff">Generate Report No</a>
					                  </span><br/><br/>
					                  <?php } ?>
					                </td>
					                <?php } ?>
