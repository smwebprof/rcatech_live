							...
							<div class="tab-pane active" id="tab_0">
								...
								<!--<div class="btn-group">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="" method="post" class="form-horizontal additemmaster-form" enctype="multipart/form-data" onsubmit="submitForm()">
											<?php
												   #print_r($this->data);
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="item_name" id="item_name">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<input type="checkbox" class="form-control" placeholder="" name="nabcb_flag" id="nabcb_flag" value="1" style="width:25%">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="col-md-offset-9 col-md-9">
															...
															<a href="<?php echo BASE_PATH;?>viewitemmaster"><button type="button" class="btn default">Cancel</button></a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
