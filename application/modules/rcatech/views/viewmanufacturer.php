					...
					<div class="portlet box grey">
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="<?php echo BASE_PATH; ?>Addmanufacturer" class="btn blue">
									<i class="fa fa-pencil"></i> Add New Manufacturer
								</a>
								<?php #} ?>
								<!-- <div class="btn-group">
						...
						<div class="portlet-body">
						    ...
						    <tr class="odd gradeX">
								...
								<td>
									 <?php 
									 if ($manufacturer_data['is_active']==1) { echo 'Yes'; } else { echo 'No';}
									 ?>
								</td>
