							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box red">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Edit Vendor Master Form
										</div>
										<div class="actions">
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control form-control-solid h-auto py-5 px-6" name="is_active" id="is_active" placeholder="is_active">
												                    ...
												                    <option value="1" <?php if ($vendor_data['is_active']==1) { echo 'selected'; }?>>Yes</option>
												                    <option value="0" <?php if ($vendor_data['is_active']==0) { echo 'selected'; }?>>No</option>  
											                  	</select>
