...
var Custom = function () {
    ...
    return {
        ...
        initCallGeneration: function () {
            $('.callgeneration-form').validate({
                ...
                messages: {
                    ...
                    call_days: {
                        required: "Call Days is required."
                    },
                    call_manufacturer: {
                        required: "Manufacturer is required."
                    },
                    call_end_client: {
                        required: "End Client No is required."
                    },
                    inspection_schedule_date: {
                        required: "Inspection Schedule Date is required."
                    },
                    company_country: {
                    ...
                    company_city: {
                        required: "Inspection City is required."
                    },
                    company_panno: {
        ...
        initCallSchedule: function () {
            $('.callschedule-form').validate({
                errorElement: 'span', //default input error message container
                errorClass: 'help-block', // default input error message class
                focusInvalid: false, // do not focus the last invalid input
                rules: {
        ...
        initCallReSchedule: function () {
            $('.callreschedule-form').validate({
                errorElement: 'span', //default input error message container
                errorClass: 'help-block', // default input error message class
                focusInvalid: false, // do not focus the last invalid input
                rules: {
        ...
        initCallCancel: function () {
            $('.callcancel-form').validate({
                errorElement: 'span', //default input error message container
                errorClass: 'help-block', // default input error message class
                focusInvalid: false, // do not focus the last invalid input
                rules: {
        ...
        initRfiSent: function () {
            $('.addrfiregister-form').validate({
                ...
                messages: {
                    ...
                    rfi_sent_date: {
                        required: "RFI Sent Date is required."
                    },
                    upl_document_type: {
                        required: "Upload RFI is required."
                    },
                    user_id: {
        ...
        initAddItemmaster: function () {
            $('.additemmaster-form').validate({
                errorElement: 'span', //default input error message container
                errorClass: 'help-block', // default input error message class
                focusInvalid: false, // do not focus the last invalid input
                rules: {
        ...
        initAddSubtypeItemmaster: function () {
            $('.addsubtypeitemmaster-form').validate({
                errorElement: 'span', //default input error message container
                errorClass: 'help-block', // default input error message class
                focusInvalid: false, // do not focus the last invalid input
                rules: {
                ...
                messages: {
                    item_subtype_name: {
                        required: "Item Subtype name is required."
                    },
                    item_id: {
                        required: "Item name is required."
                    },
        ...
        initAddManufacturer: function () {
            $('.addmanufacturer-form').validate({
                errorElement: 'span', //default input error message container
                errorClass: 'help-block', // default input error message class
                focusInvalid: false, // do not focus the last invalid input
                rules: {
